...
public class UserLeagueInfoPOJO {
    ...
    public UserLeagueInfoPOJO(String leagueUUID, String leagueName, Boolean isAdmin, int money, String rLeagueUUID, String leagueGame, Boolean activeClause, String code) {
